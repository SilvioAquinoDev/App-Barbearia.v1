...
# --- Função auxiliar para ser chamada quando o agendamento for concluído ---

async def redeem_points_from_booking(
    db: AsyncSession,
    ...
    # Buscar configuração para saber o threshold
    ...
    txn = LoyaltyTransaction(
        ...
        type="redeem",
        points=threshold,
        description=f"Resgate: {reward_description} (Agendamento #{appointment_id})",
    ...
    return {
        "message": f"Resgate realizado: {reward_description}",
